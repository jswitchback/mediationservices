...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <meta name="msapplication-TileImage" content="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/images/app-icons/ms-application-icon-144x144.png">
  <link rel="icon" sizes="196x196" href="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/images/app-icons/android-196x196.png">
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/images/app-icons/apple-touch-icon-144x144-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/images/app-icons/apple-touch-icon-114x114-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/images/app-icons/apple-touch-icon-72x72-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/images/app-icons/apple-touch-icon-57x57-precomposed.png">
  <?php endif; ?>
  ...
  <?php if ($add_respond_js): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/js/lib-vendor/html5-respond.js"></script>
    <![endif]-->
  <?php elseif ($add_html5_shim): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $GLOBALS['base_url'] . '/' . $path_to_sitename_zen; ?>/js/lib-vendor/html5.js"></script>
    <![endif]-->
  <?php endif; ?>
